        ...
        <div class="wrapper">
            <div class="sidebar" data-background-color="white" data-active-color="danger">
                <div class="sidebar-wrapper">
                    <div class="logo">
                        <a class="simple-text">
                            <img src="assets/img/equipos.png" alt="" />
                        </a>
                    </div>
                    <ul class="nav menu" id="menus">
                        <li class="active"   value="2"><a><i class="la la-user"></i></i><label style='cursor:pointer;' id="text2"></label></a></li>
                        <li class="activado" value="0"><a><i class="la la-edit"></i><p><label style='cursor:pointer;' id="text0">Actualizar contraseña</label></p></a></li>
                        <li class="activado" value="1"><a><i class="la la-book" aria-hidden="true"></i><label style='cursor:pointer;' id="text1">Crear Lista de Chequeo</label </a></li>
                        <li class="activado" value="3"><a><i class="la la-edit" aria-hidden="true"></i><label style='cursor:pointer;' id="text3">Editar Lista de Chequeo</label></a></li>
                        <li class="activado" value="2"><a><i class="la la-eye" aria-hidden="true"></i><label  style='cursor:pointer;' id="text2">Consultar P.V</label></a></li>
                        <li class="activado" value="5"><a href="linkoff"><i class="glyphicon glyphicon-off" aria-hidden="true"></i><label style='cursor:pointer;' id="text2">Cerrar Sesión</label></a></li>
                    </ul>
                </div>
